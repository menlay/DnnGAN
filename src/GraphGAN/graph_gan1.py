...
from src.evaluation.evalne.evaluation.evaluator import NREvaluator as NR
...
class GraphGAN(object):
    ...
    def build_discriminator(self):
        ...
        with tf.variable_scope("discriminator"):
            ...
            self.discriminator = sdne_dis1.SDNE(self.g, encoder_layer_list=encoder_layer_list,
    ...
    def train(self):
        ...
        #for gan&dis compare
        # train_file = '/home/ming/gittest/EvalNE/evalne/tests/data/CIteSeer/citeseer/citeseer.cites1'
        ...
        nre = NR(traintest_split, dim=200)
        ...
        for epoch in range(self.n_epoch):
            ...
            results_gen = nre.evaluate_ne(data_split=traintest_split, X=X_gen, method='MY_model', edge_embed_method='hadamard')
            results_dis = nre.evaluate_ne(data_split=traintest_split, X=X_dis, method='MY_model', edge_embed_method='hadamard')
            ...
            write_line = 'epoch {e}: {aucg}    {fscgen}    {aucd}    {fscdis}+\n'.format(e=epoch, aucg=auc_gen, fscgen=fscore_gen, aucd=auc_dis, fscdis=fscore_dis)
            with open('/home/ming/gittest/GraphGAN_数据半采样半SDNE/results/gen_dis_picture/gen_dis.txt', 'a+')as fp:
